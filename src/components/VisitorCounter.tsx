      ...
      <div className="flex items-center gap-2 md:gap-3 text-sm">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="flex items-center gap-1 md:gap-1.5 px-1.5 md:px-2 py-1 rounded-full bg-green-500/10 border border-green-500/20 cursor-default">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="flex items-center gap-1 md:gap-1.5 px-1.5 md:px-2 py-1 rounded-full bg-primary/10 border border-primary/20 cursor-default">
