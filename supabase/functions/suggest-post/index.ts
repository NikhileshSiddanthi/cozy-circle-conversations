    ...
    const response = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: 'system', 
            content: 'You are a helpful assistant that suggests engaging social media posts. Create relevant, concise posts (2-4 paragraphs) that fit the group context and encourage discussion.' 
          },
          { 
            role: 'user', 
            content: `Suggest a post for this group:
Group: ${groupName}
