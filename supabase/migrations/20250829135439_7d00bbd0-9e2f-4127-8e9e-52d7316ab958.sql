-- Complete database restructure for production readiness
-- This migration creates a clean, secure foundation

-- Drop existing policies and constraints that may conflict
...
-- Update enums if they don't exist or need modification
DO $$ 
BEGIN
...
-- Convert existing text fields to proper enums where needed
...
-- Posts policies with proper member checking
...
-- Create public read policy for post media (for group members)
